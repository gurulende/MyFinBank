...
const UserAccountsList = () => {
    ...
    // Function to fetch user accounts from the backend
    const fetchUserAccounts = async () => {
        try {
            const { data } = await axios.get('http://localhost:5000/api/accounts/getallusersaccount/users', {
                headers: {
    ...
    const handleActivate = async (id) => {
        try {
            ...
            fetchUserAccounts(); // Refetch user accounts after activation
        } catch (err) {
    ...
    const handleDeactivate = async (id) => {
        try {
            ...
            fetchUserAccounts(); // Refetch user accounts after deactivation
        } catch (err) {
